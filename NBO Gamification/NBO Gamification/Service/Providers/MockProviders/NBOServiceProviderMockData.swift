...
enum NBOMockServiceProviderPlayer {
    static let player1 = NBOPlayer(id: 1, email: "dante@evbqa.com", firstName: "Dante", lastName: "Canizo", token: "12345")
    static let player2 = NBOPlayer(id: 2, email: "karinap@evbqa.com", firstName: "Karina", lastName: "Pangaro", token: "12345")
}
